<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Regestration.aspx.cs" Inherits="AspNetTrainingClasses.Assignments.Naveen.TNSRTC.Regestration" %>
...
<body style="background-image: url('background.jpg')">
    ...
    <div class="body">
        <div class="topimage">
        <div style="height:50px; font-family:@FangSong; color: Orange; font-size:large;font-weight:bolder">
        Registration 
        </div>
